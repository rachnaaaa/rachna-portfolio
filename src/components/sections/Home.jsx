...
export const Home = () => {
    return (
        ...
        >
            ...
            ></div>
            <div 
                className="absolute inset-0 bg-gradient-to-r from-slate-900 to-slate-800 bg-opacity-80"
                style={{
            ...
            <div className="relative z-10 text-center px-6 max-w-4xl">
                ...
                <p className="mt-6 text-xl text-white">
                    A Full Stack Developer building end-to-end web solutions. Let's turn your ideas into reality!
                </p>
