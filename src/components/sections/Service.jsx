            ...
            <div className="relative z-10 text-center px-6 max-w-4xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
                    {[
                        ...
                        <div
                            key={index}
                            className="bg-gray-800 p-6 rounded-lg border border-transparent shadow-lg hover:border-teal-400 hover:shadow-teal-500/30 transition-all duration-300 cursor-pointer"
                        >
